// convertTemperatureValues.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
    ...
    PrintTableTemperature(0, 300, 20);
    std::cout << "Упражнение 2\n";
    double min = 0, max = 0, interval = 0;
    PrintHeaderTemperature();
    std::cout << "Введите минимальное значение в °C ";
    std::cin >> min;
